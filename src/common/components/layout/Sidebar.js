    ...
    return (
      ...
      <div className="sidebar">
        ...
        <div className="sidebar-item sidebar-footer">
          <p>I built this site with Redux and React. You can get the <a href="https://github.com/ALexander4295502/react-redux-portfolio" target="_blank" rel="noopener noreferrer"> source code here </a></p>
        </div>
